/** Shared SVG icon components for the Contact page social links. */
...
/** Shared SVG icon components for the Contact info bar. */

export function LocationIcon() {
  return (
    <svg className="w-5 h-5 text-[#39CA5B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
