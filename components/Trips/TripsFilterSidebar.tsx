    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <span className="font-roboto font-normal text-[#030811] text-sm">Price Range</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex-1 flex items-center bg-white border border-gray-200 rounded-xl px-3 py-2">
            <span className="font-roboto text-xs text-gray-400 mr-1">$</span>
            <input
              type="number"
              value={minPrice}
          ...
          <span className="font-roboto text-xs text-[#5B6472] px-1">To</span>
          <div className="flex-1 flex items-center bg-white border border-gray-200 rounded-xl px-3 py-2">
            <span className="font-roboto text-xs text-gray-400 mr-1">$</span>
            <input
              type="number"
      ...
      <div>
        <h3 className="font-roboto font-medium text-[#030811] text-sm mb-3">Trips Types</h3>
