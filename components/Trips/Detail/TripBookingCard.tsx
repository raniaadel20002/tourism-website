...
export default function TripBookingCard({ duration, adultPrice, childPrice, onCheckAvailability }: TripBookingCardProps) {
  return (
    <div className="w-full lg:w-[35%] lg:sticky lg:top-24 flex flex-col">
      <div className="bg-[#F3F8FB] rounded-3xl p-6 sm:p-8 shadow-xs border border-blue-50/80 flex flex-col">
        ...
        <div className="flex items-center justify-between py-2 text-xs sm:text-sm font-roboto">
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span className="font-medium text-[#000C09]">Adult</span>
          </div>
          <div className="text-right">
            <span className="text-gray-400 text-[11px] block">From</span>
            <span className="text-[#39CA5B] font-bold text-sm sm:text-base">${adultPrice} / Person</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between py-2 text-xs sm:text-sm font-roboto mt-1">
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span className="font-medium text-[#000C09]">Children 3-11 Years</span>
          </div>
          <div className="text-right">
            <span className="text-gray-400 text-[11px] block">From</span>
            <span className="text-[#39CA5B] font-bold text-sm sm:text-base">${childPrice} / Person</span>
          </div>
        </div>
