    ...
    >
      ...
      <div className="flex items-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-500 font-roboto mb-5">
        <div className="flex items-center gap-1.5 text-[#006993]">
          <svg
            className="w-4 h-4 text-[#006993] flex-shrink-0"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="font-roboto text-xs text-[#030811] font-normal">
              {rating} ({reviewCount} {t("trips.reviews", "Review")})
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#F3F8FB] rounded-2xl p-4 sm:p-5 flex flex-wrap items-center justify-between gap-4 border border-blue-50/60 text-xs sm:text-sm font-roboto">
        <div className="flex items-center gap-2 text-[#004560]">
          ...
          <span className="text-gray-700">
            ...
            <strong className="font-semibold text-[#000C09]">{duration}</strong>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 text-[#004560]">
          ...
          <span className="text-gray-700">
            {t("trips.tourType", "Tour Type")}:{" "}
            <strong className="font-semibold text-[#000C09]">{tourType}</strong>
          </span>
        </div>
      </div>
