    ...
    <div className="w-full lg:w-[62%] flex flex-col">
      ...
      <div className="flex items-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-500 font-roboto mb-5">
        ...
        <div className="flex items-center gap-1.5 text-[#F59E0B]">
          ...
          <span className="text-gray-600 font-medium">{rating} Reviews ({reviewCount})</span>
        </div>
      </div>
      ...
      <div className="bg-[#F3F8FB] rounded-2xl p-4 sm:p-5 flex flex-wrap items-center justify-between gap-4 border border-blue-50/60 text-xs sm:text-sm font-roboto">
        <div className="flex items-center gap-2 text-[#004560]">
          ...
          <span className="text-gray-700">Group: <strong className="font-semibold text-[#000C09]">{groupSize}</strong></span>
        </div>
        <div className="flex items-center gap-2 text-[#004560]">
          <svg className="w-4 h-4 text-[#006993]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span className="text-gray-700">Duration: <strong className="font-semibold text-[#000C09]">{duration}</strong></span>
        </div>
        <div className="flex items-center gap-2 text-[#004560]">
          <svg className="w-4 h-4 text-[#006993]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
          </svg>
          <span className="text-gray-700">Tour Type: <strong className="font-semibold text-[#000C09]">{tourType}</strong></span>
        </div>
      </div>
