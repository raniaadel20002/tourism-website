...
export default function TripAddReview({ onSubmit }: TripAddReviewProps) {
  ...
  return (
    <div className="w-full pt-4">
      <h3 className="font-roboto font-bold text-lg sm:text-xl text-[#000C09] mb-1">Add Review</h3>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col items-start gap-1">
          <span className="font-roboto text-xs font-medium text-gray-700">Review</span>
